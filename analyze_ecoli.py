...
from prototype_functions import analyze_ecoli ,plot_intensity_scatter, extract_lysis_ratio, print_ratio, print_gaussian_ratio, print_gaussian_ratio_2D, print_gaussian_ratio_no_infect 
