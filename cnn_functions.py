...
def run_model_on_directory(data_location, channel_names, output_location, model, win_x = 30, win_y = 30, std = False, split = True, process = True, save = True, verbose = False):
	n_features = model.layers[-1].output_shape[1]
	counter = 0
