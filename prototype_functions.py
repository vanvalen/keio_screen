...
#1D Gaussian Classifier
#plots classified data as scattergram and returns the lysis ratio
...
#Prints classified scattergram and prints the calculated lysis ratio	
